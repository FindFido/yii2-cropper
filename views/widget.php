...
<div class="cropper-widget">
    <div class="close hidden" onlcick="">x</div>
    ...
    <div class="cropper-buttons">
        ...
        <a class='flyerImageMissing crop-photo hidden text-center text-reverse btn-center big-font-btn btn btn-info btn-default col-md-4 col-md-push-4 col-xs-12'><i class="glyphicon glyphicon-camera"></i> Crop Photo *</a>
